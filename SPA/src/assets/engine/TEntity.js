...
import {getBezierPoints, convertLatLonToVec3, degrees, convertLatLonToVec3Rotated, quatFromVectors} from './tools/utils.js';
import {TResourceMesh, TResourceMeshArray} from './resourceManager';
import {getEuler} from "./tools/utils";
...
class TArc extends TEntity {
  ...
  draw() {
    if(this.count > 0) {
      ...
      global.gl.uniform4fv(this.uMaterialDiffuse, [1, 0.019, 0.792, 1]);
      global.gl.uniform4fv(this.uMaterialAmbient, [1.0, 1.0, 1.0, 1.0]);
      global.gl.uniform1i(this.uUseTextures, 0);
