...
export class CandidateProfileComponent implements OnInit, AfterViewInit {
  ...
  candidate = {
    ...
    //   '\n' +
    //   'A small, agile dog that copes very well with mountainous terrain, the Shiba Inu was originally bred'+
    //   'for hunting. It looks similar ' +
    //   'to and is often mistaken for other Japanese dog breeds like the Akita'+
    //   'Inu or Hokkaido, but the Shiba Inu is a different breed with' +
    ...
    //     start: '2016-02-16',
    //     end: '2019-01-29',
    //     description: 'Android software development is the process by' +
    //       ' which new applications are created for devices running the Android' +
    ...
    //     start: '2013-02-16',
    //     end: '2016-01-29',
    //     description: 'Android software development is the process by which new' +
    ...
    //       ' to create digital systems for the management of multimedia ' +
    //       'information, to provide technical support to multimedia projects' +
