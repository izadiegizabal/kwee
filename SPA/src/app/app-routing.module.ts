...
const routes: Routes = [
  ...
  {path: 'offer/:id/edit', loadChildren: './shared/offer-create/offer-create.module#OfferCreateModule'},
  {path: 'offer/create', loadChildren: './shared/offer-create/offer-create.module#OfferCreateModule'},
